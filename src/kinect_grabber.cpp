...
KinectGrabber::KinectGrabber( const int index )
    : sensor( nullptr )
    , mapper( nullptr )
    , result( S_OK )
...
pcl::PointCloud<pcl::PointXYZ>::Ptr KinectGrabber::convertDepthToPointXYZ( NUI_LOCKED_RECT* depthLockedRect )
{
...
pcl::PointCloud<pcl::PointXYZI>::Ptr KinectGrabber::convertInfraredDepthToPointXYZI( NUI_LOCKED_RECT* colorLockedRect, NUI_LOCKED_RECT* depthLockedRect )
{
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr KinectGrabber::convertRGBDepthToPointXYZRGB( NUI_LOCKED_RECT* colorLockedRect, NUI_LOCKED_RECT* depthLockedRect )
{
...
pcl::PointCloud<pcl::PointXYZRGBA>::Ptr KinectGrabber::convertRGBADepthToPointXYZRGBA( NUI_LOCKED_RECT* colorLockedRect, NUI_LOCKED_RECT* depthLockedRect )
{
