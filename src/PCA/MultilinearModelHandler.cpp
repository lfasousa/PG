																									...
																									, const double landmarkWeight, const std::vector<double>& initWeight, const double maxMode2Variation, const double maMode3Variaton, std::vector<double>& outWeight)
{
	...
	minimizer.set_cost_function_convergence_factor(10000000); //for higher precision: 10000000
	minimizer.set_projected_gradient_tolerance(0.00001);		//for higher precision: 0.00001
	minimizer.set_max_function_evals(1000);						//for higher precision: 1000
